...
class Myprofileadmin extends Component{
    ...
    renderRecordingData(){
        return this.state.recordings.map(recording => {
            ...
            return (
                <tr key={recording.id}>
                    <td className="tdclass">{recording.student_email}</td>
                    <td className="tdclass">{recording.student_name}</td>
        ...
        return this.state.adv.map(user => {
            return (
                <tr key={user.email}>
                    ...
                    <td className="tdclass" data-label="Action">
                        <img style={{marginRight:"3px", width:"14px"}} src={edit} onClick={() => this.setState({editModal:true, email:user.email, email:user.email, fname:user.fname ,lname:user.lname ,dob:user.dob ,role:user.role ,gender:user.gender})}/>
                        <img style={{width:"14px"}} src={deleteimage} onClick={() => this.setState({deleteId:user.email},()=>this.deleteUser())} />
                    </td>
                </tr>
            )
        })
                        ...
                        <table>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th className="thclass" scope="col">Recording</th>
                                    <th className="thclass" scope="col">Language</th>
                                    <th className="thclass" scope="col">Action</th>
                                </tr>
                            </thead>
                            <tbody>
